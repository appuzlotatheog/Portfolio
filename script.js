...
(function () {
  ...
  function initMusic() {
    ...
    const lyricsData = [
      ...
      { time: 26, text: "Try to get through it, try to push through it" },
      { time: 29, text: "You were not thinking that I will not do it" },
      { time: 32, text: "They be lovin' someone and I'm another story" },
      { time: 35, text: "Take the next ticket, get the next train" },
      { time: 38, text: "Why would I do it? Anyone'd think that" },
      { time: 41, text: "I cannot vanish, you will not scare me" },
      { time: 44, text: "Try to get through it, try to push through it" },
      { time: 47, text: "You were not thinking that I will not do it" },
      { time: 50, text: "They be lovin' someone and I'm another story" },
      { time: 53, text: "Take the next ticket, get the next train" },
      { time: 56, text: "Why would I do it? Anyone'd think that" },
      { time: 59, text: "Try to get through it, try to push through it" },
      { time: 62, text: "You were not thinking that I will not do it" },
      { time: 65, text: "They be lovin' someone and I'm another story" },
      { time: 68, text: "Take the next ticket, get the next train" },
      { time: 71, text: "Why would I do it? Anyone'd think that" },
      ...
      { time: 90, text: "Baby, now I'm ready, moving on" },
      { time: 94, text: "Oh, but maybe I was ready all along" },
      { time: 98, text: "Oh, I'm ready for the moment and the sound" },
      { time: 102, text: "Oh, but maybe I was ready all along" }
    ];
